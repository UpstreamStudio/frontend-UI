...
const GET_USERS_DATA_REQUEST: string = "dataReducer/GET_USER_DATA_REQUEST";
const GET_USERS_DATA_SUCCESS: string = "dataReducer/GET_USER_DATA_SUCCESS";
const GET_USERS_DATA_ERROR: string = "dataReducer/GET_USER_DATA_ERROR";
