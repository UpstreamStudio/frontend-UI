...
const AUTO_THEME_TOGGLE_REQUEST: string =
  "themeDucks/AUTO_THEME_TOGGLE_REQUEST";
const AUTO_THEME_TOGGLE_SUCCESS: string =
  "themeDucks/AUTO_THEME_TOGGLE_SUCCESS";
const AUTO_THEME_TOGGLE_ERROR: string = "themeDucks/AUTO_THEME_TOGGLE_ERROR";
const AUTO_THEME_TOGGLE_DAY: string = "themeDucks/AUTO_THEME_TOGGLE_DAY";
const AUTO_THEME_TOGGLE_NIGHT: string = "themeDucks/AUTO_THEME_TOGGLE_NIGHT";
...
export function* themeSaga(): Object {
